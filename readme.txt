...
1. Import ExampleTestProject_v4.0.zip by clicking on File --> Import --> Existing Project into workspace --> Select archive file --> ExampleTestProject_v4.0.zip.

2. NotePad and NotePadTest should now be seen in your projects list. 
